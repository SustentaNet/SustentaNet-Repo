...
public class MeusItens extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(414, 555, -1, -1));
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        if (idSelecionado > 0) {
            int confirmacao = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja deletar este produto?", "Confirmação de exclusão", JOptionPane.YES_NO_OPTION);
            if (confirmacao == JOptionPane.YES_OPTION) {
                Produto produto = new Produto();
                produto.deleteProdutoById(idSelecionado);
